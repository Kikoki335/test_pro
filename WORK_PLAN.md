...
8주, 2026-04-06 시작 ~ 2026-05-31 종료. 현재 1주차 완료, 2주차 진입 직전 (1주차 sub-task #1~#6 완료, 2026-05-01 기준).
...
> **마지막 갱신**: 2026-05-01 (1주차 #6 — Player↔Enemy 충돌 + HUD 완료 후. 1주차 전체 종료. 다음은 2주차 #1 — 구름 parallax 레이어)
...
| ▶ **다음** | **2주차 #1 — 구름 parallax 레이어** | §7 2주차 #1 참조 |
| ⏸ 대기 | 2주차 #2~#3, 그리고 3~8주차 전부 | |
...
| 1주차 #5 | `ENEMY`, `CONTROLLER` | `Enemy`, `EnemyGenerator` 도입 |
| 1주차 #6 | `UI` | `Score`/HUD 객체 도입 |
| 2주차 #1 | `CLOUD` | 구름 parallax `VertScrollBackground` 도입 |
